...
if __name__ == "__main__":
    ...
    current_topic = "The topic for the image should be of a random animal, preferrably cats, alligators, dogs, pandas, ducks, bears. It should be an animal name, with a prefix and or suffix, which will obstruct the image generation!"
    base_style = "playful, puffy, smooth, cute"
